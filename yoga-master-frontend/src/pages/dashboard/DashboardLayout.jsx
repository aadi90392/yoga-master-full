...
import { 
    Leaf, Home, LogOut, Menu, X, 
    PlusCircle, Users, BookOpen, Layers, History, 
    FileText, LayoutDashboard, UserCircle
} from 'lucide-react';
...
const DashboardLayout = () => {
    ...
    const dashboardLinks = {
        // 1. Instructor Links
        instructor: [
            { name: 'Dashboard', path: '/dashboard/instructor-home', icon: <LayoutDashboard size={20} /> },
        ...
        admin: [
            ...
            { name: 'Instructor Requests', path: '/dashboard/manage-applications', icon: <FileText size={20} /> }
        ],
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 
                ...
                <div className="p-6 text-center border-b border-gray-100 bg-green-50/50">
                    <img 
                        ...
                        alt="Profile" 
                        className="w-16 h-16 rounded-full mx-auto border-2 border-green-500 mb-2 object-cover"
                    />
                ...
                <nav className="p-4 space-y-2">
                    ...
                    {/* Sidebar mein bhi Profile Link add kar diya */}
                    <Link 
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                <header className="bg-white h-16 border-b border-gray-200 flex items-center justify-between px-4 lg:hidden sticky top-0 z-40">
